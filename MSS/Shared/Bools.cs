    ...
    public class Bools : IBools
    {
        ...
        public bool IsSyndAffiliates(string coverageNote)
        {
            return coverageNote.Contains("acctourney.theacc.com") || coverageNote.Contains("theacc.com/live") || coverageNote.Contains("raycomsports")
                || coverageNote.Contains("SECNetWk") || coverageNote.Contains("Big12NetWk") || (coverageNote.Contains("wacsports") && !coverageNote.ToLower().Contains("wacsports.com/live") && !coverageNote.ToLower().Contains("swacsports")) || coverageNote.Contains("theacc.com/news")
        ...
        public bool isConferenceTournament(string sport, string game)
        {
            return sport == "basketball" && (game.ToLower().Contains("first round") || game.ToLower().Contains("second round") 
                || game.ToLower().Contains("quarterfinal") || game.ToLower().Contains("semifinal") || game.ToLower().Contains("championship"));
        }
    }
}