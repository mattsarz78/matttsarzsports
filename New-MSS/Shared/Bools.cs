...
namespace New_MSS.Shared
{
    public class Bools
    {
        public static bool IsImage(string coverageNote)
        {
        ...
        public static bool IsImageHyperlink(string coverageNote)
        {
        ...
        public static bool IsTextStreamingLink(string coverageNote)
        {
        ...
        public static bool IsOleMissLHN(string coverageNote)
        {
            return coverageNote.Contains("http://www.olemisssports.com/sports/m-footbl/spec-rel/071613aab.html");
        }

        public static bool IsPPVProviders(string coverageNote)
        {
        ...
        public static bool IsGamePlanMap(string coverageNote)
        {
            return coverageNote.Contains("http://assets.espn.go.com/gameplan/") || coverageNote.Contains("espngameplan.espn.com");
        }

        public static bool IsThe506CoverageMap(string coverageNote)
        {
            return coverageNote.Contains("http://www.the506.com");
        }

        public static bool IsCoverageMap(string coverageNote)
        {
        ...
        public static bool IsSyndAffiliates(string coverageNote)
        {
        ...
        private static bool IsASNLink(string coverageNote)
        {
        ...
        public static bool IsFOXSportsGo(string coverageNote)
        {
            return coverageNote.ToLower().Contains("foxsportsgo.com");
        }

		public static bool CheckSportYearAttributesBool(string p, string attributeName)
		{
		...
		public static string CheckSportYearAttributes(string p, string attributeName)
		{
			var path = HttpContext.Current.Server.MapPath(@"~/Content/ValidSportYears.xml");
			if (File.Exists(path))
			{
		...
		public static bool IsESPNPPV(string ppv, string coverageNotes)
		{
